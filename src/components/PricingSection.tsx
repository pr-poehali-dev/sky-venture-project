      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-12 space-y-4">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-balance">
            Выберите <span className="text-primary">идеальный уход</span> для ваших ноготков
          </h2>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Честные цены без скрытых доплат — от классики до сложного дизайна
          </p>
        </div>
        ...
        <div className="mt-12 text-center">
          <p className="text-sm text-muted-foreground">
            Все услуги включают <span className="text-primary font-semibold">стерильные инструменты</span> и{" "}
            <span className="text-primary font-semibold">премиум-материалы</span>
          </p>
        </div>
      </div>
    </section>
