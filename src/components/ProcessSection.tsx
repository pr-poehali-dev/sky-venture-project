...
const steps = [
  {
    ...
    title: "Запись онлайн",
    description:
      "Выбираете удобную дату и время прямо на сайте. Указываете желаемые услуги и дизайн — мы подтверждаем запись за пару минут.",
    number: "01",
  },
  {
    icon: PaletteIcon,
    title: "Выбор дизайна",
    description:
      "Подбираем форму, длину и оттенок под ваш образ. Покажем актуальные тренды или воплотим вашу собственную идею.",
    number: "02",
  },
  {
    icon: Rocket,
    ...
    description:
      "Создаём безупречный маникюр с заботой о здоровье ногтей. Вы уходите с красивыми ручками и отличным настроением.",
    number: "03",
  },
]
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 text-balance">
            От <span className="text-primary">записи</span> к <span className="text-primary">красоте</span>
          </h2>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto text-pretty leading-relaxed">
            Всего три простых шага — и вы наслаждаетесь идеальным маникюром без лишних хлопот.
          </p>
        </div>
